...
/**
 * The template for displaying taxonomy-news pages
 *
...
<main>
    ...
    <section class="archive-news">
        <div class="container">
            ...
            <div class="archive-news__items">
                <?php if (have_posts()) : while (have_posts()) : the_post(); ?>

                        <div class="archive-news__item">
                            ...
                            <div class="archive-news__item-info">
                                <div class="archive-news__item-header">
                                    ...
                                    if ($has_term) {
                                        echo '<div class="archive-news__item-tag tag">' . $term_name . '</div>';
                                    }
                                    ?>
                                </div>
                                ...
                                <div class="archive-news__item-descr"><?php echo esc_html(khag_get_trimmed_excerpt(220)); ?></div>

                                <a href="<?php the_permalink(); ?>" class="archive-news__item-link">Подробнее</a>
